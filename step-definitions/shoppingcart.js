module.exports = function () {
  ...
  this.Given(/^that I am on the Fruit and Vegetable category page "([^"]*)"$/, async function (url) {
    ...
    await driver.executeScript('document.querySelector(\'a[href="/sortiment/frukt-och-gront"]\').scrollIntoView()');
    // Wait for the h2 headline (there is only one) to become "Frukt & Grönt"
  ...
  this.When(/^I put a random number of each Fruit and Vegetable that has price per piece in the cart$/, async function () {
